...
class StringTreeNode:
    ...
    def validate_token_logp_consistency(self) -> bool:
        """Validate that token_ids, logp, and loss_mask have consistent
        lengths."""
...
class StringRadixTrie:
    ...
    def insert(
        ...
        """Insert a string and its corresponding token IDs, log probabilities,
        and loss mask into the trie.
    ...
    def remove(self, text: str) -> bool:
        """Remove a string and all nodes with this text as prefix from the
        trie.
    ...
    def _validate_subtree_weight_versions(self, node: StringTreeNode):
        """Validate that all nodes in subtree have weight_version <= parent
        weight_version.
